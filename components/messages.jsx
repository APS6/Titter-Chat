...
export default function Messages() {
  ...
  return (
    <div
      className="flex flex-col gap-2 scroll-smooth h-[70svh] overflow-scroll"
      ref={messagesRef}
    >
